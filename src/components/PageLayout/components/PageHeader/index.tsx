  ...
  return (
    <div className="relative min-h-[200px] w-full bg-[linear-gradient(170deg,_var(--tw-gradient-stops))] from-primary via-primary to-secondary to-75% md:min-h-[263px] lg:min-h-[343px]">
      <div className="absolute inset-0 flex justify-center px-4">
        <div className="flex w-full max-w-screen-2xl flex-col items-start justify-center">
          <div className="flex w-full flex-col sm:flex-row sm:items-center sm:justify-between lg:justify-start">
            <div className="w-full">
              ...
              <h1 className="text-[26px] leading-[30px] text-white sm:text-4xl sm:leading-[46px] md:text-title-lg lg:text-[60px] lg:leading-[72px]">
                {title}
              </h1>

              {subtitle && (
                <div className="w-full">
                  <p className="mt-2 line-clamp-5 max-w-7xl text-[13px] font-medium leading-[20px] text-white sm:text-base sm:leading-[22px] md:text-lg lg:mt-4 lg:text-[22px] lg:leading-[28px]">
                    {subtitle}
                  </p>
                </div>
              )}
      ...
      {showSections && sections && (
        <div className="absolute bottom-[-56.5px] right-0 mx-auto hidden h-[113px] w-auto items-center justify-between rounded-l-[20px] bg-primary pl-6 pr-10 text-white lg:flex">
          <div className="ml-[30px] flex items-center gap-4 text-[24px] font-medium">
