  ...
  return (
    <div className="mb-10 ml-11 mr-9 flex-1 text-darkGray md:ml-9 md:mr-16 lg:ml-16 lg:mt-4">
      <p className="text-base md:text-xl">
        ...
        todas as suas empresas subsidiárias, controladas, coligadas ou que de
        alguma forma integrem sua estrutura (“Oncoclínicas”), atendendo aos
        requisitos de transparência preconizados na Lei 13.709/2018 (“Lei Geral
        de Proteção de Dados Pessoais” ou “LGPD”), vem, por meio deste Aviso de
        Privacidade e Proteção/ Tratamento de Dados (“Aviso”), explicar como são
        coletados, tratados e compartilhados os dados pessoais e dados pessoais
        sensíveis (em conjunto, “dados pessoais”) dos seus clientes,
        colaboradores, terceirizados e/ou prestadores de serviços que, em
        conjunto, serão denominados “Usuários”.
      </p>
      <p className="mt-8 text-base md:text-xl">
        Todas as práticas de tratamento de dados pessoais realizadas pelas
        Oncoclínicas estão sujeitas às leis aplicáveis nos locais em que atua no
        Brasil ou no exterior e seguem o objetivo da LGPD.
      </p>
      <p className="mt-8 text-base md:text-xl">
        Em caso de dúvidas quanto ao conteúdo deste Aviso, contate a área
        responsável da Oncoclínicas pela proteção de dados pessoais por meio do
      ...
      <p className="mt-8 text-base md:text-xl">
        ...
        contratações e processos seletivos; no cadastro do Usuário nas clínicas
        ou no centro de serviços compartilhados; por meio de cadastro em nosso
        website{" "}
        <Link href="https://grupooncoclinicas.com">
          {" "}
          https://grupooncoclinicas.com
        </Link>
        ; durante a prestação de serviços pela/para a Oncoclínicas; no canal de
        compliance da empresa; entre outras situações, como durante a relação de
        negócios com terceiros em que há transferência de dados pessoais.
      </p>
      <p className="mt-8 text-base md:text-xl">
        Os dados obtidos por meio do acesso ao website da Oncoclínicas, como
        endereço de IP e cookies, são informações anonimizadas e agregadas para
        fins que incluem: teste de sistemas de TI, criação de modelos de
      ...
      <p className="mt-8 text-base md:text-xl">
        ...
        missão, visão e valores. Entretanto, este consentimento não é necessário
        quando estes dados forem tratados para tutela da saúde do Usuário; ou
        por interesse legítimo da empresa; ou para cumprimento de obrigações
        legais ou regulatórias; e/ou quando necessários para a execução de
        contrato no qual o Usuário é parte.
      </p>
      <p className="mt-8 text-base md:text-xl">
        Além disso, a Oncoclínicas utiliza os dados pessoais coletados conforme
        o princípio da transparência lgpd para: (i) suporte ao Usuário; (ii)
        pesquisa e desenvolvimento de serviços; (iii) estabelecimento de vínculo
        contratual ou a gestão, administração, prestação, ampliação e
        melhoramento dos serviços ao Usuário; e (iv) lidar com denúncia lgpd ou
        quaisquer outras reclamações/sugestões dos Usuários.
      </p>
      <p className="mt-8 text-base md:text-xl">
        Todas as informações coletadas poderão ser utilizadas para fins de
        relacionamento com o Usuário, como para o envio de informações de novos
        serviços e especialidades oferecidos pela Oncoclínicas, a divulgação de
        eventos ou para a realização de pesquisa de satisfação.
      </p>
      <p className="mt-8 text-base md:text-xl">
        Além disso, a Oncoclínicas poderá subcontratar um terceiro para
        tratamento de dados, nos moldes da legislação aplicável, garantindo que
        este seja submetido às obrigações deste Aviso.
      </p>
      <h1 className="mt-10 text-2xl text-primary md:text-4xl">
        III. Em quais situações os dados dos Usuários podem ser compartilhados?
      </h1>
      <p className="mt-8 text-base md:text-xl">
        ...
        dados pessoais; e/ou nos casos em que o consentimento não é necessário,
      ...
      <ul className="ml-8 list-disc text-base md:text-xl">
        ...
        <li>
          ...
          do titular, exceto nas hipóteses de guarda legal e outras dispostas na
          legislação aplicável;
        </li>
        <li>
          Direito à informação das entidades públicas e privadas com as quais a
          Oncoclínicas realizou uso compartilhado de Dados;
        </li>
        <li>
      ...
      <p className="mt-8 text-base md:text-xl">
        A Oncoclínicas está empenhada em proteger os dados pessoais dos Usuários
        conforme os termos LGPD. São envidados todos os esforços para proteger
        os seus dados pessoais de uso indevido, interferência, perda, acesso não
        autorizado, modificação ou divulgação.
      </p>
      <p className="mt-8 text-base md:text-xl">
        ...
        internas foram atualizadas para assegurar a segurança dos dados pessoais
        dos Usuários, assim como todos os colaboradores e prestadores de
        serviços médicos da Oncoclínicas foram instruídos a realizar um
        treinamento obrigatório sobre como devem ser tratados os dados pessoais
        aos quais eles têm acesso.
      </p>
      <p className="mt-8 text-base md:text-xl">
        Apesar das medidas adotadas, nenhum sistema é completamente seguro.
        Nesse sentido, a Oncoclínicas se compromete a informar o Usuário em caso
        de qualquer incidente com seus dados pessoais, nos termos da lei nº
        13.709/2018.”).
      </p>
      <h1 className="mt-10 text-2xl text-primary md:text-4xl">
      ...
      <p className="mt-8 text-base md:text-xl">
        Em caso de dúvidas quanto ao conteúdo deste Aviso, contate a área
        responsável da Oncoclínicas pela proteção de dados pessoais, pelo e-mail
        dpo@oncoclinicas.com.
      </p>
      <p className="text-base md:text-xl">
