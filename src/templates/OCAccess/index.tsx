...
"
    >
      <h1 className="my-4 text-2xl text-primary md:my-11 md:text-[40px] md:leading-[48px]">
      ...
      <div className="full-bleed flex flex-col-reverse md:h-[285px] md:flex-row lg:h-[418px]">
        <div className="flex flex-col bg-custom-gradient-dark p-6 md:w-2/5 lg:w-full lg:rounded-bl-[100px] lg:p-12">
          <h2 className="text-[26px] leading-6 text-white lg:text-3xl lg:!leading-9 2xl:text-5xl">
            É para pacientes oncológicos, com custo acessível, é pra mim
          </h2>
          <p className="mt-5 text-sm text-white lg:mt-10 lg:text-2xl lg:leading-[24px]">
            O cuidado completo do maior grupo de oncologia da América Latina,
            agora está acessível a todos.
          </p>
          <BaseButton
            variant="bordered"
            className="mt-5 w-60 border-1 border-white text-white lg:mt-10 lg:w-80"
          >
            Saiba Mais
          </BaseButton>
        </div>
      ...
      <div className="full-bleed flex flex-col-reverse md:h-[285px] md:flex-row lg:h-[418px]">
        <img
          ...
          className="object-cover md:w-3/5 lg:rounded-bl-[100px]"
          alt="Banner OC Acesso"
        />

        <div className="flex flex-col justify-between bg-gradient-to-b from-secondary via-secondary to-purpleLight p-6 md:w-2/5 lg:px-10 lg:py-12">
          <h2 className="text-[26px] leading-6 text-white lg:text-3xl 2xl:text-5xl">
            É superespecializado, é excelente, é pra mim
          </h2>
          <p className="3xl:text-2xl text-sm text-white lg:text-xl lg:leading-[24px]">
          ...
          <div className="mt-4 grid grid-cols-2 gap-6">
            {options.map((option, index) => {
              ...
              return (
                <div
                  key={option.id}
                  className={`flex h-32 flex-col rounded-2xl p-4 md:h-[233px] lg:p-7 ${bgColor}`}
                >
                  <p className="text-sm font-semibold md:text-[40px] lg:leading-10">
                    {option.step}
                  </p>
                  <p className="text-sm font-semibold !leading-3 md:mt-6 md:text-2xl md:!leading-8 lg:mt-2 lg:text-xl lg:font-semibold 2xl:text-2xl">
                    {option.title}
                  </p>
                </div>
              );
