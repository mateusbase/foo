  ...
  return (
    <Element name="how-works" id="how-works" className="text-darkGray">
      ...
      <p className="mt-3 text-xl md:mt-6 lg:mt-4">
        Através de uma abordagem individualizada, a equipe de especialistas da
        OC Estomatologia utiliza a laserterapia, uma tecnologia de ponta que
...
export default HowProgramWorksSection;
