...
const RightFullbleedBanner = ({
  ...
  return (
    <div className="full-bleed mb-14 flex flex-col-reverse md:flex-row md:items-stretch lg:mt-12">
      <div className="flex h-[320px] flex-col gap-5 bg-custom-gradient-light pb-11 pl-8 pr-4 pt-9 font-lato-regular text-white md:h-[380px] md:w-1/2 md:pl-8 md:pr-20 md:pt-8 lg:h-[508px] lg:rounded-bl-[100px] lg:pb-12 lg:pl-16 lg:pr-11 lg:pt-[71px]">
