    ...
    <PageLayout title="Nossos exames">
      <div className="mt-5 flex flex-row gap-16">
        ...
        <div className="flex w-3/4 flex-col gap-7">
          {selectedItem && (
            <>
              <h1 className="mb-10 font-lato-bold text-5xl text-primary">
                {selectedItem.label}
              </h1>
              <p className="font-lato-regular text-xl text-darkGray">
                {selectedItem.description}
              </p>
              <BaseButton className="mb-5 h-14 w-[245px] rounded-md px-32 py-3 font-lato-thin text-white">
                Solicitar exame
              </BaseButton>
