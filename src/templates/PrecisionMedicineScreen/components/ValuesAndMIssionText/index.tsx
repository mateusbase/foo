  ...
  return (
    <div className="flex flex-col">
      <div className="mb-5 gap-2">
        <h3 className="mb-2 font-lato-regular text-4xl text-primary">
          Nossa missão
        </h3>
        <span className="font-lato-regular text-lg text-darkGray">
      ...
      <div>
        ...
        <span className="justify-center text-justify font-lato-regular text-lg text-darkGray">
      ...
      <p className="mt-4 w-[95%] text-justify font-lato-regular text-darkGray">
      ...
      <p className="mb-7 mt-4 w-[95%] text-justify font-lato-regular text-darkGray">
