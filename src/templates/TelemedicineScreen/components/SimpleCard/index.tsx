...
const SimpleCard = ({
  ...
  return (
    <div className="flex min-h-[250px] w-full flex-col justify-between gap-6 rounded-2xl border border-darkGray bg-white px-[27px] pt-6 md:min-h-[260px] lg:w-1/4 lg:pb-11 xl:min-h-[250px]">
