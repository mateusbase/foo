...
const PreventionSection = (): JSX.Element => {
  return (
    <div className="full-bleed lg:mb-40 lg:mt-12 lg:flex lg:flex-row lg:items-stretch">
      ...
      <div className="flex flex-col gap-3 bg-custom-gradient-dark px-10 pb-20 pt-12 font-lato-regular text-white md:pb-[99px] md:pl-[138px] md:pr-[140px] md:pt-[90px] lg:w-[45%] lg:shrink-0 lg:gap-6 lg:pb-[111px] lg:pl-11 lg:pr-10 lg:pt-[118px]">
        ...
        <BaseButton className="w-full self-center border border-white bg-transparent text-white md:w-[482px] lg:ml-0 lg:w-[442px]">
