      ...
      <div className="mt-2 flex flex-col lg:flex-row">
        ...
        <div className="mb-10 ml-11 mr-9 flex-1 text-darkGray md:ml-9 md:mr-16 lg:ml-16 lg:mt-4">
          <p className="text-base md:text-xl">
            {" "}
            A Oncoclínicas do Brasil Serviços Médicos S.A., em seu nome e em
            nome de todas as suas empresas subsidiárias, controladas, coligadas
            ou que de alguma forma integrem sua estrutura (“Oncoclínicas”),
            atendendo aos requisitos de transparência preconizados na Lei
            13.709/2018 (“Lei Geral de Proteção de Dados Pessoais” ou “LGPD”),
            vem, por meio deste Aviso de Privacidade e Proteção/ Tratamento de
            Dados (“Aviso”), explicar como são coletados, tratados e
            compartilhados os dados pessoais e dados pessoais sensíveis (em
            conjunto, “dados pessoais”) dos seus clientes, colaboradores,
            terceirizados e/ou prestadores de serviços que, em conjunto, serão
          ...
          <p className="mt-8 text-base md:text-xl">
            ...
            Oncoclínicas estão sujeitas às leis aplicáveis nos locais em que
            atua no Brasil ou no exterior e seguem o objetivo da LGPD.
          </p>
          <p className="mt-8 text-base md:text-xl">
          ...
          <p className="mt-8 text-base md:text-xl">
            Seguindo o protocolo LGPD A coleta de dados pessoais pela
            Oncoclínicas ocorre normalmente durante a interação com a empresa,
            como: em contratações e processos seletivos; no cadastro do Usuário
            nas clínicas ou no centro de serviços compartilhados; por meio de
            cadastro em nosso website{" "}
          ...
          <p className="mt-8 text-base md:text-xl">
            ...
            para fins que incluem: teste de sistemas de TI, criação de modelos
            de marketing e promoção e melhorar, aprimorar e desenvolver os
            serviços desempenhados pela Oncoclínicas.
          </p>
          <h1 className="mt-10 text-2xl text-primary md:text-4xl">
          ...
          <p className="mt-8 text-base md:text-xl">
            ...
            determinados casos, com o consentimento do Usuário de acordo com
            nosso missão, visão e valores. Entretanto, este consentimento não é
            necessário quando estes dados forem tratados para tutela da saúde do
            Usuário; ou por interesse legítimo da empresa; ou para cumprimento
            de obrigações legais ou regulatórias; e/ou quando necessários para a
          ...
          <p className="mt-8 text-base md:text-xl">
            ...
            lidar com denúncia lgpd ou quaisquer outras reclamações/sugestões
            dos Usuários.
          </p>
          <p className="mt-8 text-base md:text-xl">
            ...
            divulgação de eventos ou para a realização de pesquisa de
            satisfação.
          </p>
          <p className="mt-8 text-base md:text-xl">
          ...
          <p className="mt-8 text-base md:text-xl">
            ...
            necessário, conforme definido na legislação aplicável. Caso
            atendidas estas condições, estes dados poderão ser compartilhados:
          </p>
          <ul className="ml-8 list-disc text-base md:text-xl">
            <li>
              Com as subsidiárias, controladas, coligadas e empresas que de
              alguma forma integrem a estrutura da Oncoclínicas, assim como suas
              respectivas sucessoras;
            </li>
            <li>
              Com terceiros, para desenvolvimento de serviços voltados ao
              Usuário;
            </li>
            <li>
              Com autoridades ou entidades governamentais, para cumprir
              obrigação legal ou no âmbito de qualquer inquérito ou processo
          ...
          <h1 className="mt-10 text-2xl text-primary md:text-4xl">
            IV. Quais são os direitos dos Usuários em relação aos dados
            coletados?
          </h1>
          <p className="mt-8 text-base md:text-xl">
          ...
          <ul className="ml-8 list-disc text-base md:text-xl">
            ...
            <li>
              Direito à eliminação dos dados pessoais tratados com o
              consentimento do titular, exceto nas hipóteses de guarda legal e
              outras dispostas na legislação aplicável;
            </li>
            <li>
              Direito à informação das entidades públicas e privadas com as
              quais a Oncoclínicas realizou uso compartilhado de Dados;
            </li>
            <li>
          ...
          <p className="mt-8 text-base md:text-xl">
            ...
            Usuários conforme os termos LGPD. São envidados todos os esforços
            para proteger os seus dados pessoais de uso indevido, interferência,
            perda, acesso não autorizado, modificação ou divulgação.
          </p>
          <p className="mt-8 text-base md:text-xl">
            ...
            pessoais dos Usuários, assim como todos os colaboradores e
            prestadores de serviços médicos da Oncoclínicas foram instruídos a
            realizar um treinamento obrigatório sobre como devem ser tratados os
            dados pessoais aos quais eles têm acesso.
          </p>
          <p className="mt-8 text-base md:text-xl">
            ...
            caso de qualquer incidente com seus dados pessoais, nos termos da
            lei nº 13.709/2018.”).
          </p>
          <h1 className="mt-10 text-2xl text-primary md:text-4xl">
          ...
          <p className="text-base md:text-xl">
            ...
            <Link href="https://grupooncoclinicas.com/app/politica-de-privacidade-e-tratamento-de-dados-do-oncoclinicas-por-voce-politica">
              <span className="underline underline-offset-4">
                Política de privacidade e tratamento de dados do Oncoclínicas
                Por Você (“política”).
              </span>
            </Link>{" "}
          </p>
