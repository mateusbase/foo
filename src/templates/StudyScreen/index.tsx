...
export default function StudyScreen(): JSX.Element {
  return (
    <main>
      ...
      >
        <div className="mt-10 flex flex-col items-start lg:mt-0">
        ...
        <div>
          <p className="mb-[46px] mt-6 text-sm text-lightGray md:text-xl lg:mt-12">
            EMBER-4: Um estudo randomizado, aberto, de fase 3 de terapia
            endócrina adjuvante imlunestrant vs terapia endócrina adjuvante
            padrão em pacientes que receberam anteriormente 2 a 5 anos de
            terapia endócrina adjuvante para ER+, HER2- câncer de mama precoce
            com risco aumentado de recorrência
          </p>
        </div>
        ...
        <div className="mt-10 flex flex-col gap-7">
          ...
          <p className="mt-4 text-sm text-lightGray md:text-xl lg:mt-12">
            ...
            <span className="text-sm text-lightGray md:text-xl">
              ...
              raloxifeno.Participantes com histórico de qualquer outro câncer.
              <br />
              Apresentar condições médicas preexistentes graves que, a juízo do
              pesquisador, impossibilitariam a participação neste estudo.
            </span>
          </p>
        </div>
        ...
        <div className="mb-7 mt-10 flex flex-col gap-7 md:mb-[70px]">
          ...
          <BaseButton className="text-white md:w-80">
