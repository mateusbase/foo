    ...
    <PageLayout title="Oc na mídia">
      <div className="mb-10 mt-20 flex flex-col items-center justify-center px-4 md:px-0">
        ...
        <p className="mt-6 text-left text-base leading-7 text-darkGray md:text-2xl">
          A Oncoclínicas foi reconhecida pelo seu trabalho de excelência na área
          da saúde, recebendo um importante prêmio de destaque na prestação de
          serviços médicos. A empresa continua a se destacar pelo seu
          compromisso com a inovação, qualidade no atendimento e o compromisso
          com os pacientes. Este reconhecimento reforça o papel da Oncoclínicas
          como referência nacional e internacional em tratamentos oncológicos. A
          premiação foi entregue durante uma cerimônia que contou com a presença
          de líderes da área da saúde e representantes do setor. A empresa
          reafirma sua missão de fornecer cuidado de alta qualidade, voltado
          para a humanização e excelência.
        </p>
