...
const FullbleedBanner = ({
  ...
  return (
    <div className="full-bleed mb-14 lg:mt-12 lg:flex lg:flex-row lg:items-stretch">
      ...
      <div className="flex flex-col bg-custom-gradient-dark px-10 pb-14 pt-12 font-lato-regular text-white md:py-14 md:pl-7 md:pr-20 lg:h-auto lg:w-[45%] lg:shrink-0 lg:pb-24 lg:pl-14 lg:pr-24 lg:pt-[112px]">
        {title && (
